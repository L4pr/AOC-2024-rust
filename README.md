...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `138.1µs` | `155.3µs` |
| [Day 2](./src/bin/02.rs) | `284.8µs` | `316.5µs` |
| [Day 3](./src/bin/03.rs) | `168.4µs` | `124.5µs` |
| [Day 4](./src/bin/04.rs) | `279.1µs` | `97.2µs` |
| [Day 5](./src/bin/05.rs) | `486.6µs` | `712.7µs` |
| [Day 6](./src/bin/06.rs) | `109.4µs` | `10.8ms` |
| [Day 7](./src/bin/07.rs) | `501.9µs` | `559.0µs` |
| [Day 8](./src/bin/08.rs) | `23.1µs` | `24.1µs` |
| [Day 9](./src/bin/09.rs) | `637.4µs` | `123.1ms` |
| [Day 10](./src/bin/10.rs) | `825.9µs` | `158.9µs` |
| [Day 11](./src/bin/11.rs) | `209.4µs` | `11.9ms` |
| [Day 12](./src/bin/12.rs) | `3.5ms` | `6.3ms` |
| [Day 13](./src/bin/13.rs) | `384.6µs` | `173.3µs` |
| [Day 14](./src/bin/14.rs) | `152.4µs` | `9.3ms` |
| [Day 15](./src/bin/15.rs) | `195.5µs` | `864.7µs` |
| [Day 16](./src/bin/16.rs) | `33.1ms` | `33.3ms` |
| [Day 17](./src/bin/17.rs) | `1.7µs` | `525.2µs` |
| [Day 18](./src/bin/18.rs) | `1.8ms` | `3.8s` |
| [Day 19](./src/bin/19.rs) | `2.0ms` | `23.3ms` |
| [Day 20](./src/bin/20.rs) | `19.6ms` | `95.2ms` |
| [Day 21](./src/bin/21.rs) | `144.8µs` | `493.3µs` |
| [Day 22](./src/bin/22.rs) | `8.3ms` | `1.3s` |
| [Day 23](./src/bin/23.rs) | `162.7ms` | `120.1ms` |
| [Day 24](./src/bin/24.rs) | `683.8µs` | `28.4ms` |
| [Day 25](./src/bin/25.rs) | `616.7µs` | `-` |
